...
struct CodeEditorView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> EditorContainerView {
        ...
        // The pane's ground, shared with every other code pane. This is the only
        // colour this file spells: the syntax tokens, the current-line and
        // bracket-match painting and the minimap all keep `SyntaxTheme`'s, and
        // `CodeEditorView.swift` is deliberately not in the chrome's gated set.
