...
- `MainWindowFrameAutosave.swift` — explicit frame autosave name and restore-before-adopt rule.
...
`app-window.md`), `MainWindowFrameSourceGatingTests` (the explicit main-window
autosave name and restore-before-adopt rules) and `LintConfigurationTests`
